...
const ConfirmCashOut = () => {
    ...
    const handleConfirm = async (e) => {
        ...
        const confirmation = await axiosSecure.post(`/user/request/cash-out`, sendInfo);
    ...
    return (
        <div className='w-full text-center flex flex-col justify-center items-center gap-4'>
            <p className='text-white mx-auto'>Cash-out request to  <span className='py-1 underline'>{phoneNumber}</span></p>
